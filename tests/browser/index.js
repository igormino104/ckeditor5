/**
 * @license Copyright (c) 2025, TPsoft.org. All rights reserved.
 * For licensing podpora@tpsoft.org
 */
...
const PRODUCTIVITY_PACK_LICENSE_KEY = 'GPL';

import '../../dist/browser/ckeditor5.css';

//import ClassicEditor from '../../dist/ckeditor5.js';
import { ClassicEditor, Essentials, Autoformat, BlockQuote, Bold, CloudServices, Code, CodeBlock,
...
class ClassCKEDITOR {
	...
	replace(element_name) {
		...
		.catch((error) => {
			console.error('ERROR: ckeditor5-tpsoft');
			console.error(error);
		});
	}
}
